        ...
        $scope.permissions = [
            {
                ...
                permissions: [
                    ...
                    { active: false, id: 'manage_emojis_and_stickers',         name: 'Manage Emojis and Stickers',         value: 0x40000000,    auto: false },
                    { active: false, id: 'manage_webhooks',                    name: 'Manage Webhooks',                    value: 0x20000000,    auto: false },
                    { active: false, id: 'view_channel',                       name: 'Read Messages/View Channels',        value: 0x400,         auto: true  },
                    { active: false, id: 'manage_events',                      name: 'Manage Events',                      value: 0x200000000,   auto: true  },
                    { active: false, id: 'moderate_members',                   name: 'Moderate Members',                   value: 0x10000000000, auto: false },
                    { active: false, id: 'view_guild_insights',                name: 'View Server Insights',               value: 0x80000,       auto: true  },
                    { active: false, id: 'view_creator_monetization_insights', name: 'View Creator Monetization Insights', value: 0x20000000000, auto: true  }
                ]
            },
            {
                name: 'Text',
                ...
                permissions: [
                    ...
                    { active: false, id: 'create_public_threads',    name: 'Create Public Threads',     value: 0x800000000,  auto: true  },
                    { active: false, id: 'create_private_threads',   name: 'Create Private Threads',    value: 0x1000000000, auto: true  },
                    { active: false, id: 'send_messages_in_threads', name: 'Send Messages in Threads',  value: 0x4000000000, auto: true  },
                    ...
                    { active: false, id: 'manage_threads',           name: 'Manage Threads',            value: 0x400000000,  auto: false },
                    ...
                    { active: false, id: 'use_external_stickers',    name: 'Use External Stickers',     value: 0x2000000000, auto: true  },
                    { active: false, id: 'add_reactions',            name: 'Add Reactions',             value: 0x40,         auto: true  },
                    { active: false, id: 'use_application_commands', name: 'Use Application Commands',  value: 0x80000000,   auto: true  },
                ]
            },
            {
                name: 'Voice',
                ...
                permissions: [
                    ...
                    { active: false, id: 'stream',                  name: 'Video',                      value: 0x200,           auto: true },
                    ...
                    { active: false, id: 'use_embedded_activities', name: 'Use Embedded Activities',    value: 0x8000000000,    auto: true }
                ]
            }
        ];
