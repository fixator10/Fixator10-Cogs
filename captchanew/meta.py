__author__ = ["Predeactor", "Fixator10"]

# Please indicate who made which release. Any user making a release is a cog's author. See __author__
# 1.0.2: Predeactor
# 1.0.3: Fixator10
# 2.0.dev1: Predeactor
